...
class TradingStrategy(Strategy):
    def __init__(self):
        ...
        self.tickers = ["QQQ", "DBC", "XLV", "TECL", "TQQQ", "XLK", "SOXX", "IJT"]
        self.SafeAssets = ["IEF", "TLT", "BIL", "TIP", "GLD"]
        self.Canary = ["SLV", "XLI", "XLU", "UUP", "DBB"]
        self.RiskAsset = "QQQ"
        self.SafeAsset = "BIL"
        self.HighRiskAssets = ["TECL", "TQQQ"]
    ...
    def run(self, data):
        ...
        if self.bull:
            ...
            if QQQVola > self.VolaThreashold:
                ...
                for sym in self.HighRiskAssets:
                    sorted_assets_by_momentum.remove(sym)
    ...
    def calculate_momentum_scores(self, data):
        ...
        for asset in self.tickers:
            ...
            if sma > 0:  # Avoid division by zero
                ...
                #momentum_score = (close_data - (close_data - close_prices[-self.VOLA_LOOKBACK])) - (close_data - (close_data - close_prices[-15]))
            else:
                momentum_score = 0.0
