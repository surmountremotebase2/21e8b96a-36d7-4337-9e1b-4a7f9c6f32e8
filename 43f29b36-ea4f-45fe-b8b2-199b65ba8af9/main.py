...
class TradingStrategy(Strategy):
    ...
    def run(self, data):
        ...
        slvm = slvDF.close.pct_change(82).iloc[-1] - spyDF.close.pct_change(21).iloc[-1]
        gldm = gldDF.close.pct_change(82).iloc[-1] - spyDF.close.pct_change(21).iloc[-1]
        ...
        if ratioMAS.iloc[-1] > ratioMAL.iloc[-1] and slvm > gldm and mrktMAS[-1] > mrktMAL[-1]:
